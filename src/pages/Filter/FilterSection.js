        ...
        <div className="dkewjriwehrnjhweijrwer mb-4">
          ...
          <div className="deowjnkrwere bdfgsdfseewewrr">
            {filterCategories.map(filterCategory => {
              ...
              const mainCategorySlug = filterCategory.mainCategory_slug.toLowerCase(); // from API
              const isAllProducts = currentPath.includes("all-products");
              const showMainCategory = isAllProducts || mainCategorySlug === currentPath;

              if (!showMainCategory) return null; // skip other main categories

              // Automatically expand the current category for subcategories if not all-products
                      ...
                      <div className="main-catgry-filter px-2">
                        <div className="radio-wrapper-5">
                          <div className="oijdmeiojewrer d-flex justify-content-between w-100 align-items-center">
                            ...
                            {/* Only show main category input/label/plus-minus if current URL does NOT match */}
                        ...
                        {/* Subcategories (always show if expanded) */}
                                      ...
                                      <div className="checkbox-wrapper-33">
                                        <label htmlFor={`sbctgry-${sub_category.id}`} className="checkbox">
                                          <input
                                            ...
                                            onChange={() => setSubCategory(filterCategory.mainCategory_name.toLowerCase(), sub_category.subCategories_name.toLowerCase())}
